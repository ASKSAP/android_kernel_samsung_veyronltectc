...
static void mdnie_init(struct samsung_display_driver_data *vdd)
{
	...
	if (mdnie_data) {
		...
		mdnie_data[0].COLOR_BLIND_MDNIE_1 = DSI0_COLOR_BLIND_MDNIE_1;
		mdnie_data[0].RGB_SENSOR_MDNIE_1 = DSI0_RGB_SENSOR_MDNIE_1;
		mdnie_data[0].RGB_SENSOR_MDNIE_2 = DSI0_RGB_SENSOR_MDNIE_2;
		mdnie_data[0].RGB_SENSOR_MDNIE_3 = DSI0_RGB_SENSOR_MDNIE_3;
		mdnie_data[0].TRANS_DIMMING_MDNIE = DSI0_RGB_SENSOR_MDNIE_3;
		mdnie_data[0].UI_DYNAMIC_MDNIE_2 = DSI0_UI_DYNAMIC_MDNIE_2;
		mdnie_data[0].UI_STANDARD_MDNIE_2 = DSI0_UI_STANDARD_MDNIE_2;
		mdnie_data[0].UI_AUTO_MDNIE_2 = DSI0_UI_AUTO_MDNIE_2;
		mdnie_data[0].VIDEO_DYNAMIC_MDNIE_2 = DSI0_VIDEO_DYNAMIC_MDNIE_2;
		mdnie_data[0].VIDEO_STANDARD_MDNIE_2 = DSI0_VIDEO_STANDARD_MDNIE_2;
		mdnie_data[0].VIDEO_AUTO_MDNIE_2 = DSI0_VIDEO_AUTO_MDNIE_2;
		mdnie_data[0].CAMERA_MDNIE_2 = DSI0_CAMERA_MDNIE_2;
		mdnie_data[0].CAMERA_AUTO_MDNIE_2 = DSI0_CAMERA_AUTO_MDNIE_2;
		mdnie_data[0].GALLERY_DYNAMIC_MDNIE_2 = DSI0_GALLERY_DYNAMIC_MDNIE_2;
		mdnie_data[0].GALLERY_STANDARD_MDNIE_2 = DSI0_GALLERY_STANDARD_MDNIE_2;
		mdnie_data[0].GALLERY_AUTO_MDNIE_2 = DSI0_GALLERY_AUTO_MDNIE_2;
		mdnie_data[0].VT_DYNAMIC_MDNIE_2 = DSI0_VT_DYNAMIC_MDNIE_2;
		mdnie_data[0].VT_STANDARD_MDNIE_2 = DSI0_VT_STANDARD_MDNIE_2;
		mdnie_data[0].VT_AUTO_MDNIE_2 = DSI0_VT_AUTO_MDNIE_2;
		mdnie_data[0].BROWSER_DYNAMIC_MDNIE_2 = DSI0_BROWSER_DYNAMIC_MDNIE_2;
		mdnie_data[0].BROWSER_STANDARD_MDNIE_2 = DSI0_BROWSER_STANDARD_MDNIE_2;
		mdnie_data[0].BROWSER_AUTO_MDNIE_2 = DSI0_BROWSER_AUTO_MDNIE_2;
		mdnie_data[0].EBOOK_DYNAMIC_MDNIE_2 = DSI0_EBOOK_DYNAMIC_MDNIE_2;
		mdnie_data[0].EBOOK_STANDARD_MDNIE_2 = DSI0_EBOOK_STANDARD_MDNIE_2;
		mdnie_data[0].EBOOK_AUTO_MDNIE_2 = DSI0_EBOOK_AUTO_MDNIE_2;
		mdnie_data[0].TDMB_DYNAMIC_MDNIE_2 = DSI0_TDMB_DYNAMIC_MDNIE_2;
		mdnie_data[0].TDMB_STANDARD_MDNIE_2 = DSI0_TDMB_STANDARD_MDNIE_2;
		mdnie_data[0].TDMB_AUTO_MDNIE_2 = DSI0_TDMB_AUTO_MDNIE_2;
		...
		mdnie_data[0].GAME_LOW_MDNIE = DSI0_GAME_LOW_MDNIE;
		mdnie_data[0].GAME_MID_MDNIE = DSI0_GAME_MID_MDNIE;
		mdnie_data[0].GAME_HIGH_MDNIE = DSI0_GAME_HIGH_MDNIE;
		mdnie_data[0].TDMB_DYNAMIC_MDNIE = DSI0_TDMB_DYNAMIC_MDNIE;
		mdnie_data[0].TDMB_STANDARD_MDNIE = DSI0_TDMB_STANDARD_MDNIE;
		mdnie_data[0].TDMB_NATURAL_MDNIE = DSI0_TDMB_NATURAL_MDNIE;
		mdnie_data[0].TDMB_MOVIE_MDNIE = DSI0_TDMB_MOVIE_MDNIE;
		mdnie_data[0].TDMB_AUTO_MDNIE = DSI0_TDMB_AUTO_MDNIE;
		mdnie_data[0].GRAYSCALE_MDNIE = DSI0_GRAYSCALE_MDNIE;
		mdnie_data[0].GRAYSCALE_NEGATIVE_MDNIE= DSI0_GRAYSCALE_NEGATIVE_MDNIE;
		mdnie_data[0].CURTAIN = DSI0_SCREEN_CURTAIN_MDNIE;
		mdnie_data[0].NIGHT_MODE_MDNIE = DSI0_NIGHT_MODE_MDNIE;
		mdnie_data[0].NIGHT_MODE_MDNIE_1 = DSI0_NIGHT_MODE_MDNIE_1;
		mdnie_data[0].COLOR_BLIND_MDNIE_SCR = DSI0_COLOR_BLIND_MDNIE_1;
		mdnie_data[0].RGB_SENSOR_MDNIE_SCR = DSI0_RGB_SENSOR_MDNIE_1;

		mdnie_data[0].mdnie_tune_value = mdnie_tune_value_dsi0;
		mdnie_data[0].hmt_color_temperature_tune_value = hmt_color_temperature_tune_value_dsi0;

		mdnie_data[0].hdr_tune_value = hdr_tune_value_dsi0;
		...
		mdnie_data[0].mdnie_step_index[MDNIE_STEP3] = MDNIE_STEP3_INDEX;
		...
		mdnie_data[0].rgb_sensor_mdnie_3_size = DSI0_RGB_SENSOR_MDNIE_3_SIZE;

		mdnie_data[0].trans_dimming_data_index = MDNIE_TRANS_DIMMING_DATA_INDEX;

		mdnie_data[0].adjust_ldu_table = adjust_ldu_data;
		mdnie_data[0].max_adjust_ldu = 6;
		mdnie_data[0].night_mode_table = night_mode_data;
		mdnie_data[0].scr_step_index = MDNIE_STEP1_INDEX;
