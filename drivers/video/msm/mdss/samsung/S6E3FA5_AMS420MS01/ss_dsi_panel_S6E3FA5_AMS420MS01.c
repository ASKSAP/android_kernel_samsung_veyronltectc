...
static int mdss_octa_id_read(struct mdss_dsi_ctrl_pdata *ctrl)
{
	...
	if (vdd->dtsi_data[ndx].octa_id_rx_cmds[vdd->panel_revision].cmd_cnt) {
		memset(octa_id_buffer, 0x00, MAX_OCTA_ID);

		mdss_samsung_panel_data_read(ctrl,
			&(vdd->dtsi_data[ndx].octa_id_rx_cmds[vdd->panel_revision]),
...
static struct dsi_panel_cmds * mdss_gamma(struct mdss_dsi_ctrl_pdata *ctrl, int *level_key)
{
	...
	if (IS_ERR_OR_NULL(vdd->smart_dimming_dsi[ndx]->generate_gamma)) {
		pr_err("%s generate_gamma is NULL error", __func__);
		return NULL;
	} else if (IS_ERR_OR_NULL(vdd->dtsi_data[ndx].gamma_tx_cmds[vdd->panel_revision].cmds)) {
		pr_err("%s cmds is NULL error", __func__);
		return NULL;
	} else if (IS_ERR_OR_NULL(vdd->dtsi_data[ndx].gamma_tx_cmds[vdd->panel_revision].cmds[0].payload)) {
		pr_err("%s payload is NULL error", __func__);
		return NULL;
	} else {
...
static void mdnie_init(struct samsung_display_driver_data *vdd)
{
	...
	mdnie_data = kzalloc(sizeof(struct mdnie_lite_tune_data) * 2, GFP_KERNEL);
	if (!mdnie_data) {
	...
	for (idx = 0; idx < 2; idx++) {
		...
		mdnie_data[idx].COLOR_BLIND_MDNIE_1 = DSI0_COLOR_BLIND_MDNIE_1;
		mdnie_data[idx].RGB_SENSOR_MDNIE_1 = DSI0_RGB_SENSOR_MDNIE_1;
		mdnie_data[idx].RGB_SENSOR_MDNIE_2 = DSI0_RGB_SENSOR_MDNIE_2;
		mdnie_data[idx].RGB_SENSOR_MDNIE_3 = DSI0_RGB_SENSOR_MDNIE_3;
		mdnie_data[idx].TRANS_DIMMING_MDNIE = DSI0_RGB_SENSOR_MDNIE_3;
		mdnie_data[idx].UI_DYNAMIC_MDNIE_2 = DSI0_UI_DYNAMIC_MDNIE_2;
		mdnie_data[idx].UI_STANDARD_MDNIE_2 = DSI0_UI_STANDARD_MDNIE_2;
		mdnie_data[idx].UI_AUTO_MDNIE_2 = DSI0_UI_AUTO_MDNIE_2;
		mdnie_data[idx].VIDEO_DYNAMIC_MDNIE_2 = DSI0_VIDEO_DYNAMIC_MDNIE_2;
		mdnie_data[idx].VIDEO_STANDARD_MDNIE_2 = DSI0_VIDEO_STANDARD_MDNIE_2;
		mdnie_data[idx].VIDEO_AUTO_MDNIE_2 = DSI0_VIDEO_AUTO_MDNIE_2;
		mdnie_data[idx].CAMERA_MDNIE_2 = DSI0_CAMERA_MDNIE_2;
		mdnie_data[idx].CAMERA_AUTO_MDNIE_2 = DSI0_CAMERA_AUTO_MDNIE_2;
		mdnie_data[idx].GALLERY_DYNAMIC_MDNIE_2 = DSI0_GALLERY_DYNAMIC_MDNIE_2;
		mdnie_data[idx].GALLERY_STANDARD_MDNIE_2 = DSI0_GALLERY_STANDARD_MDNIE_2;
		mdnie_data[idx].GALLERY_AUTO_MDNIE_2 = DSI0_GALLERY_AUTO_MDNIE_2;
		mdnie_data[idx].VT_DYNAMIC_MDNIE_2 = DSI0_VT_DYNAMIC_MDNIE_2;
		mdnie_data[idx].VT_STANDARD_MDNIE_2 = DSI0_VT_STANDARD_MDNIE_2;
		mdnie_data[idx].VT_AUTO_MDNIE_2 = DSI0_VT_AUTO_MDNIE_2;
		mdnie_data[idx].BROWSER_DYNAMIC_MDNIE_2 = DSI0_BROWSER_DYNAMIC_MDNIE_2;
		mdnie_data[idx].BROWSER_STANDARD_MDNIE_2 = DSI0_BROWSER_STANDARD_MDNIE_2;
		mdnie_data[idx].BROWSER_AUTO_MDNIE_2 = DSI0_BROWSER_AUTO_MDNIE_2;
		mdnie_data[idx].EBOOK_DYNAMIC_MDNIE_2 = DSI0_EBOOK_DYNAMIC_MDNIE_2;
		mdnie_data[idx].EBOOK_STANDARD_MDNIE_2 = DSI0_EBOOK_STANDARD_MDNIE_2;
		mdnie_data[idx].EBOOK_AUTO_MDNIE_2 = DSI0_EBOOK_AUTO_MDNIE_2;
		mdnie_data[idx].TDMB_DYNAMIC_MDNIE_2 = DSI0_TDMB_DYNAMIC_MDNIE_2;
		mdnie_data[idx].TDMB_STANDARD_MDNIE_2 = DSI0_TDMB_STANDARD_MDNIE_2;
		mdnie_data[idx].TDMB_AUTO_MDNIE_2 = DSI0_TDMB_AUTO_MDNIE_2;

		mdnie_data[idx].BYPASS_MDNIE = DSI0_BYPASS_MDNIE;
		mdnie_data[idx].NEGATIVE_MDNIE = DSI0_NEGATIVE_MDNIE;
		mdnie_data[idx].COLOR_BLIND_MDNIE = DSI0_COLOR_BLIND_MDNIE;
		mdnie_data[idx].HBM_CE_MDNIE = DSI0_HBM_CE_MDNIE;
		mdnie_data[idx].RGB_SENSOR_MDNIE = DSI0_RGB_SENSOR_MDNIE;
		mdnie_data[idx].UI_DYNAMIC_MDNIE = DSI0_UI_DYNAMIC_MDNIE;
		mdnie_data[idx].UI_STANDARD_MDNIE = DSI0_UI_STANDARD_MDNIE;
		mdnie_data[idx].UI_NATURAL_MDNIE = DSI0_UI_NATURAL_MDNIE;
		mdnie_data[idx].UI_MOVIE_MDNIE = DSI0_UI_MOVIE_MDNIE;
		mdnie_data[idx].UI_AUTO_MDNIE = DSI0_UI_AUTO_MDNIE;
		mdnie_data[idx].VIDEO_OUTDOOR_MDNIE = NULL;
		mdnie_data[idx].VIDEO_DYNAMIC_MDNIE = DSI0_VIDEO_DYNAMIC_MDNIE;
		mdnie_data[idx].VIDEO_STANDARD_MDNIE = DSI0_VIDEO_STANDARD_MDNIE;
		mdnie_data[idx].VIDEO_NATURAL_MDNIE = DSI0_VIDEO_NATURAL_MDNIE;
		mdnie_data[idx].VIDEO_MOVIE_MDNIE = DSI0_VIDEO_MOVIE_MDNIE;
		mdnie_data[idx].VIDEO_AUTO_MDNIE = DSI0_VIDEO_AUTO_MDNIE;
		mdnie_data[idx].VIDEO_WARM_OUTDOOR_MDNIE = DSI0_VIDEO_WARM_OUTDOOR_MDNIE;
		mdnie_data[idx].VIDEO_WARM_MDNIE = DSI0_VIDEO_WARM_MDNIE;
		mdnie_data[idx].VIDEO_COLD_OUTDOOR_MDNIE = DSI0_VIDEO_COLD_OUTDOOR_MDNIE;
		mdnie_data[idx].VIDEO_COLD_MDNIE = DSI0_VIDEO_COLD_MDNIE;
		mdnie_data[idx].CAMERA_OUTDOOR_MDNIE = DSI0_CAMERA_OUTDOOR_MDNIE;
		mdnie_data[idx].CAMERA_MDNIE = DSI0_CAMERA_MDNIE;
		mdnie_data[idx].CAMERA_AUTO_MDNIE = DSI0_CAMERA_AUTO_MDNIE;
		mdnie_data[idx].GALLERY_DYNAMIC_MDNIE = DSI0_GALLERY_DYNAMIC_MDNIE;
		mdnie_data[idx].GALLERY_STANDARD_MDNIE = DSI0_GALLERY_STANDARD_MDNIE;
		mdnie_data[idx].GALLERY_NATURAL_MDNIE = DSI0_GALLERY_NATURAL_MDNIE;
		mdnie_data[idx].GALLERY_MOVIE_MDNIE = DSI0_GALLERY_MOVIE_MDNIE;
		mdnie_data[idx].GALLERY_AUTO_MDNIE = DSI0_GALLERY_AUTO_MDNIE;
		mdnie_data[idx].VT_DYNAMIC_MDNIE = DSI0_VT_DYNAMIC_MDNIE;
		mdnie_data[idx].VT_STANDARD_MDNIE = DSI0_VT_STANDARD_MDNIE;
		mdnie_data[idx].VT_NATURAL_MDNIE = DSI0_VT_NATURAL_MDNIE;
		mdnie_data[idx].VT_MOVIE_MDNIE = DSI0_VT_MOVIE_MDNIE;
		mdnie_data[idx].VT_AUTO_MDNIE = DSI0_VT_AUTO_MDNIE;
		mdnie_data[idx].BROWSER_DYNAMIC_MDNIE = DSI0_BROWSER_DYNAMIC_MDNIE;
		mdnie_data[idx].BROWSER_STANDARD_MDNIE = DSI0_BROWSER_STANDARD_MDNIE;
		mdnie_data[idx].BROWSER_NATURAL_MDNIE = DSI0_BROWSER_NATURAL_MDNIE;
		mdnie_data[idx].BROWSER_MOVIE_MDNIE = DSI0_BROWSER_MOVIE_MDNIE;
		mdnie_data[idx].BROWSER_AUTO_MDNIE = DSI0_BROWSER_AUTO_MDNIE;
		mdnie_data[idx].EBOOK_DYNAMIC_MDNIE = DSI0_EBOOK_DYNAMIC_MDNIE;
		mdnie_data[idx].EBOOK_STANDARD_MDNIE = DSI0_EBOOK_STANDARD_MDNIE;
		mdnie_data[idx].EBOOK_NATURAL_MDNIE = DSI0_EBOOK_NATURAL_MDNIE;
		mdnie_data[idx].EBOOK_MOVIE_MDNIE = DSI0_EBOOK_MOVIE_MDNIE;
		mdnie_data[idx].EBOOK_AUTO_MDNIE = DSI0_EBOOK_AUTO_MDNIE;
		mdnie_data[idx].EMAIL_AUTO_MDNIE = DSI0_EMAIL_AUTO_MDNIE;
		mdnie_data[idx].GAME_LOW_MDNIE = DSI0_GAME_LOW_MDNIE;
		mdnie_data[idx].GAME_MID_MDNIE = DSI0_GAME_MID_MDNIE;
		mdnie_data[idx].GAME_HIGH_MDNIE = DSI0_GAME_HIGH_MDNIE;
		mdnie_data[idx].TDMB_DYNAMIC_MDNIE = DSI0_TDMB_DYNAMIC_MDNIE;
		mdnie_data[idx].TDMB_STANDARD_MDNIE = DSI0_TDMB_STANDARD_MDNIE;
		mdnie_data[idx].TDMB_NATURAL_MDNIE = DSI0_TDMB_NATURAL_MDNIE;
		mdnie_data[idx].TDMB_MOVIE_MDNIE = DSI0_TDMB_MOVIE_MDNIE;
		mdnie_data[idx].TDMB_AUTO_MDNIE = DSI0_TDMB_AUTO_MDNIE;
		mdnie_data[idx].GRAYSCALE_MDNIE = DSI0_GRAYSCALE_MDNIE;
		mdnie_data[idx].GRAYSCALE_NEGATIVE_MDNIE= DSI0_GRAYSCALE_NEGATIVE_MDNIE;
		mdnie_data[idx].CURTAIN = DSI0_SCREEN_CURTAIN_MDNIE;
		mdnie_data[idx].NIGHT_MODE_MDNIE = DSI0_NIGHT_MODE_MDNIE;
		mdnie_data[idx].NIGHT_MODE_MDNIE_1 = DSI0_NIGHT_MODE_MDNIE_1;
		mdnie_data[idx].COLOR_BLIND_MDNIE_SCR = DSI0_COLOR_BLIND_MDNIE_1;
		mdnie_data[idx].RGB_SENSOR_MDNIE_SCR = DSI0_RGB_SENSOR_MDNIE_1;

		mdnie_data[idx].mdnie_tune_value = mdnie_tune_value_dsi0;
		mdnie_data[idx].hmt_color_temperature_tune_value = hmt_color_temperature_tune_value_dsi0;
		mdnie_data[idx].hdr_tune_value = hdr_tune_value_dsi0;

		/* Update MDNIE data related with size, offset or index */
		mdnie_data[idx].bypass_mdnie_size = ARRAY_SIZE(DSI0_BYPASS_MDNIE);

		mdnie_data[idx].mdnie_color_blinde_cmd_offset = MDNIE_COLOR_BLINDE_CMD_OFFSET;
		mdnie_data[idx].mdnie_step_index[MDNIE_STEP1] = MDNIE_STEP1_INDEX;
		mdnie_data[idx].mdnie_step_index[MDNIE_STEP2] = MDNIE_STEP2_INDEX;
		mdnie_data[idx].mdnie_step_index[MDNIE_STEP3] = MDNIE_STEP3_INDEX;
		mdnie_data[idx].address_scr_white[ADDRESS_SCR_WHITE_RED_OFFSET] = ADDRESS_SCR_WHITE_RED;
		mdnie_data[idx].address_scr_white[ADDRESS_SCR_WHITE_GREEN_OFFSET] = ADDRESS_SCR_WHITE_GREEN;
		mdnie_data[idx].address_scr_white[ADDRESS_SCR_WHITE_BLUE_OFFSET] = ADDRESS_SCR_WHITE_BLUE;

		mdnie_data[idx].rgb_sensor_mdnie_1_size = DSI0_RGB_SENSOR_MDNIE_1_SIZE;
		mdnie_data[idx].rgb_sensor_mdnie_2_size = DSI0_RGB_SENSOR_MDNIE_2_SIZE;
		mdnie_data[idx].rgb_sensor_mdnie_3_size = DSI0_RGB_SENSOR_MDNIE_3_SIZE;
		mdnie_data[idx].trans_dimming_data_index = MDNIE_TRANS_DIMMING_DATA_INDEX;

		mdnie_data[idx].adjust_ldu_table = adjust_ldu_data;
		mdnie_data[idx].max_adjust_ldu = 6;
		mdnie_data[idx].night_mode_table = night_mode_data;
		mdnie_data[idx].max_night_mode_index = 11;
		mdnie_data[idx].scr_step_index = MDNIE_STEP1_INDEX;

		LCD_ERR("mDNIe init[%d]..\n", idx);
	}
