...
static void mdnie_init(struct samsung_display_driver_data *vdd)
{
	...
	if (mdnie_data) {
		...
		mdnie_data[0].CAMERA_MDNIE_2 = DSI0_CAMERA_AUTO_MDNIE_2;
		...
		mdnie_data[0].VIDEO_WARM_OUTDOOR_MDNIE = DSI0_VIDEO_OUTDOOR_MDNIE;
		mdnie_data[0].VIDEO_WARM_MDNIE = DSI0_VIDEO_OUTDOOR_MDNIE;
		mdnie_data[0].VIDEO_COLD_OUTDOOR_MDNIE = DSI0_VIDEO_OUTDOOR_MDNIE;
		mdnie_data[0].VIDEO_COLD_MDNIE = DSI0_VIDEO_OUTDOOR_MDNIE;
		mdnie_data[0].CAMERA_OUTDOOR_MDNIE = DSI0_CAMERA_OUTDOOR_MDNIE;
		mdnie_data[0].CAMERA_MDNIE = DSI0_CAMERA_AUTO_MDNIE;
		...
		mdnie_data[0].TDMB_MOVIE_MDNIE = DSI0_TDMB_NATURAL_MDNIE;
		mdnie_data[0].TDMB_AUTO_MDNIE = DSI0_TDMB_AUTO_MDNIE;

		mdnie_data[0].mdnie_tune_value_dsi0 = mdnie_tune_value_dsi0;
		mdnie_data[0].mdnie_tune_value_dsi1 = mdnie_tune_value_dsi0;
