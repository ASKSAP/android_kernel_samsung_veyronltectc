...
#define SMB1351_STATUS_INTERRUPT				0x0D
...
#define FAST_CHARGING_DISABLE_BY_USER	0x0001
#define FAST_CHARGING_DISABLE_BY_DTV	0x0002
...
struct smb1351_charger_data {
	...
	struct delayed_work	volt_change_work;

	struct wake_lock qc_wake_lock;
	struct wake_lock volt_change_lock;
