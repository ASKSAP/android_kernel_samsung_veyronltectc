						...
						struct sdhci_msm_host *msm_host)
{
	...
	pdata->broken_ddr50 = of_property_read_bool(np, "sec,broken-ddr50");
	pdata->broken_sdr104 = of_property_read_bool(np, "sec,broken-sdr104");
...
static int sdhci_msm_probe(struct platform_device *pdev)
{
	...
	if (msm_host->pdata->broken_ddr50)
		host->quirks2 |= SDHCI_QUIRK2_BROKEN_DDR50;
	if (msm_host->pdata->broken_sdr104)
